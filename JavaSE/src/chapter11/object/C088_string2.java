...
public class C088_string2 {

	public static void main(String[] args) {
		// length
		String str = "아름다운 우리나라";
		System.out.println("길이 : " + str.length() );
		System.out.println("2번째 index 문자 : " + str.charAt(2));
		...
		System.out.println("뒤쭉 String = " + str2.lastIndexOf("String"));
		...
		System.out.println(str4);	// 문자열 자체의 변경 X
		
		// trim
		String str5 = "   Kim Sang Hyung   ";
		System.out.println(str5.trim()); // 내부 공백 X
		// concat
		System.out.println(str5.trim().concat("바보"));
		...
		// join
		String path = String.join("/", "user", "detail", "app", "local");
